...
import { getCoaches, isAbortError, type CoachItem, type Paginated } from '../lib/api';
...
export function CoachesPage() {
  ...
  useEffect(() => {
    ...
    getCoaches({}, c.signal)
      .then(setData)
      .catch((e: unknown) => {
        // Ordinary AbortController cancellation (navigation, Strict Mode,
        // unmount, duplicate request) must not appear as a user-facing error.
        if (isAbortError(e, c.signal)) return;
