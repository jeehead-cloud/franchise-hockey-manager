...
- **Competitions (F17):** `/competitions`, `/competitions/:competitionId`, `/competitions/:competitionId/editions/:editionId` — definitions, editions, participants, stages, rules, readiness (no schedules/standings yet)
