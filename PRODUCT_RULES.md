...
- Draft-class players are generated with the same generator used for regular rosters, at the appropriate (young) age (F25 youth generation feeds the future draft class).
- Draft order, lottery, draft screen, and pick/rights mechanics: **not yet implemented** — F27.
